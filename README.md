...
> ⚠️ These endpoints are **unauthenticated** (inherited from the original deployment).
> Do not expose the workers.dev URL publicly; restrict access with Cloudflare Access or
> add a shared-secret check before exposing it.
